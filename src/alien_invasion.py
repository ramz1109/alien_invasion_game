...
class AlienInvasion:
    ...
    def _check_bullet_alien_collisions(self):
        ...
        #Remove any bulelts and aliens that have collided.
    ...
    def _create_fleet(self):
        ...
        current_x, current_y = alien_width, alein_height
        while current_y < (self.settings.screen_height - 3 * alein_height):
